...
import utils2, matutils  # utility fnc for pickling, common scipy operations etc
...
class Word2Vec(utils2.SaveLoad):
    """
    ...
    def train(self, sentences, total_words=None, word_count=0, chunksize=100):
        ...
        for job_no, job in enumerate(utils2.grouper(prepare_sentences(), chunksize)):
...
class Sent2Vec(utils2.SaveLoad):
...
class LineSentence(object):
    ...
    def __iter__(self):
        ...
        try:
            ...
            with utils2.smart_open(self.source) as fin:
                for line in fin:
                    yield utils2.to_unicode(line).split()
