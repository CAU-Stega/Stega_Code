...
parser.add_argument('-seed', type=int, default=123, \
                    help='random seed for initialization [default:123]')
...
def data_loader(text_field, label_field, args,  **kwargs):
    ...
    train_iter, valid_iter = data.Iterator.splits(
        ...
        batch_sizes=(args.batch_size, len(valid_data)), **kwargs)
...
if args.test:
    ...
    test_iter = data.Iterator.splits([test_data], batch_sizes=[args.batch_size],
